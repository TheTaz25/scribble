...
<style lang="scss">
@use '../../assets/vars.scss' as breakpoints;
...
.flex-grid {
  ...
  @media screen and (breakpoints.$break-up-tablet <=width <=breakpoints.$break-up-desktop) {
    .flex-item {
  ...
  @media screen and (breakpoints.$break-up-desktop <=width <=breakpoints.$break-up-large) {
    .flex-item {
  ...
  @media screen and (breakpoints.$break-up-large <=width) {
    .flex-item {
